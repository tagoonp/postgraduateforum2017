          ...
          <div class="col-sm-12">
            ...
            <div class="card">
              ...
              <div class="card-block">
                <form class="js-validation-bootstrap form-horizontal" action="../controller/update-submission.php" method="post" >

                  <div class="form-group" style="display: none;">
                      <label class="col-md-3 control-label" for="val-username">Sess ID <span class="text-red">**</span></label>
                      <div class="col-md-8">
                          <input class="form-control" type="text" id="val-sessid" name="val-sessid" placeholder="Choose a nice username..." value="<?php echo $rowSubmission['sess_id'];?>"/>
                      </div>
                  </div>

                  <div class="form-group" style="display: none;">
                      <label class="col-md-3 control-label" for="val-username">Submission ID <span class="text-red">**</span></label>
                      <div class="col-md-8">
                          <input class="form-control" type="text" id="val-subid" name="val-subid" placeholder="Choose a nice username..." value="<?php echo $rowSubmission['submission_id'];?>"/>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <select class="form-control" id="reg_type" name="reg_type" size="1">
                       ...
                       <option value="1" <?php if($rowSubmission['presentation_type']==1){ echo "selected"; } ?>>Oral presentation </option>
                       <option value="2" <?php if($rowSubmission['presentation_type']==2){ echo "selected"; } ?>>Poster presentation</option>
                     </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <select class="form-control" id="topic_type" name="topic_type" size="1">
                       ...
                       <option value="1" <?php if($rowSubmission['topic_group']==1){ echo "selected"; } ?>>Universal health coverage </option>
                       <option value="2" <?php if($rowSubmission['topic_group']==2){ echo "selected"; } ?>>Health workforce and finance</option>
                       <option value="3" <?php if($rowSubmission['topic_group']==3){ echo "selected"; } ?>>Primary health care</option>
                       <option value="4" <?php if($rowSubmission['topic_group']==4){ echo "selected"; } ?>>Health equity</option>
                       <option value="5" <?php if($rowSubmission['topic_group']==5){ echo "selected"; } ?>>Policy integration for sustainable development</option>
                       <option value="6" <?php if($rowSubmission['topic_group']==6){ echo "selected"; } ?>>Health systems for sustainable development</option>
                       <option value="7" <?php if($rowSubmission['topic_group']==7){ echo "selected"; } ?>>Health in sustainable development goals</option>
                     </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <textarea class="form-control" id="txt-title" name="txt-title" rows="6" placeholder="Enter title.."><?php echo $rowSubmission['title']; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8 col-md-offset-3" style="padding-top: 0px; margin-top: 0px;">
                      <p style="font-size: 0.9em;" class="text-red text-center">
                        <strong>Note! </strong>Please click update this submission after add new or update author.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" id="pname" name="pname" placeholder="Enter presenter's full name ..." value="<?php echo $rowSubmission['presenter_name']; ?>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class="" id="a">
                        <textarea class="form-control" id="txt-abstract" name="txt-abstract" rows="20" placeholder="Enter your abstract..."><?php echo $rowSubmission['abstract']; ?></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group" style="display: none;">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" id="wcount" name="wcount" placeholder="Enter presenter's full name ..." value="<?php echo $rowSubmission['word_count'];?>" readonly />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8 col-md-offset-3">
                      <button type="submit" name="button" class="btn btn-app" id="btnSubmit">Update</button>
                    </div>
                  </div>
            ...
            <div class="modal-content">
                ...
                <form class="js-validation-bootstrap-mini1 form-horizontal">
                  ...
                  <div class="card-block">
                      ...
                      <div class="form-group" style="display:none;">
                          <label class="col-md-4 control-label" for="val-username">AU ID <span class="text-red">**</span></label>
                          <div class="col-md-7">
                              <input class="form-control" type="text" id="val-auid" name="val-auid" placeholder="Choose a nice username..." />
                          </div>
                      </div>
