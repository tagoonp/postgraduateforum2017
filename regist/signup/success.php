          ...
          <div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
            ...
            if(isset($_GET['s'])){
              if($_GET['s']==1){
                ...
                ?>
                <h3 class="text-center" style="font-weight: 400;">Activation success</h3>
                <p class="text-center">Your account has been activeted. Please go to login.</p>
                <form class="js-validation-bootstrap form-horizontal" action="../controller/authen.php" method="post" style="padding-top: 30px;" >
              ...
              ?>
              <h3 class="text-center" style="font-weight: 400;">Registration success</h3>
              <p class="text-center">Please check your e-mail and follow the steps.</p>
              <form class="js-validation-bootstrap form-horizontal" action="../controller/authen.php" method="post" style="padding-top: 30px;" >
