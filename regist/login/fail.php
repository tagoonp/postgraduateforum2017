...
<head>
    ...
    <!-- Document title -->
    <title>PostgradForum2017 progress fail</title>
          ...
          <div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
            ...
            if(isset($_GET['p'])){
              if($_GET['p']==1){
                ...
                ?>
                <h3 class="text-center" style="font-weight: 400;">Login fail</h3>
                <p class="text-center">Invalid username or password. Please go to login.</p>
                <form class="js-validation-bootstrap form-horizontal" action="../controller/authen.php" method="post" style="padding-top: 30px;" >
              ...
              ?>
              <h3 class="text-center" style="font-weight: 400;">Error-404</h3>
