      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
            ...
            <h3 class="text-center" style="font-weight: 400;">Need help with your password?</h3>
            <p class="text-center">Enter the email address you use for postgraduateforum2017 account, and we’ll help you create a new password.</p>
            <form class="js-validation-bootstrap form-horizontal" action="../controller/sendresetlink.php" method="post" style="padding-top: 30px;" >
              <div class="form-group">
                  <label class="col-md-4 control-label" for="val-username">E-mail <span class="text-orange">*</span></label>
                  <div class="col-md-7">
                      <input class="form-control" type="email" id="username" name="username" autofocus placeholder="Choose username or E-mail address ..." />
                  </div>
              </div>
              <div class="form-group">
                <div class="col-sm-12 text-center" style="padding-top: 20px;">
                  <button class="btn btn-app">Send reset password link</button>
                </div>
              </div>
            </form>
          </div>
