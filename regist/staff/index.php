          ...
          <div class="container-fluid" style="padding-left: 0px;">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li ><a href="slist.php"  style="color: #fff;">Submitted list</a></li>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: top;">
                                <div class="btn-group">
                                    ...
                                    <a href="javascript:redirect('submission_edit.php?sid=<?php echo $value['submission_id'];?>')" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit your submission"><i class="fa fa-cog"></i></a>
