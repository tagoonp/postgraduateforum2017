        ...
        <div class="row" style="padding-top: 0px;">
          <div class="col-sm-12">
            ...
            <!-- <div class="card"> -->
                ...
                <form class="js-form1 validation form-horizontal" action="../controller/update-register.php?callback=participant" method="post" autocomplete="off" >
                    <!-- Steps Content -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <select class="form-control" id="travel_type" name="travel_type" size="1">
                               ...
                               <option value="1" <?php if($rowinfo['travel']==1){ echo "selected"; } ?>>Plain</option>
