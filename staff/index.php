                          ...
                          <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1" style="padding-top: 80px;">
                            <div class="card">
                              ...
                              <div class="card-block" style="padding: 0px 24px ;">
                                <a href="./" style="color: rgb(89, 89, 89);"><i class="fa fa-home"></i> Home</a>
                              </div>
                              ...
                              <div class="card-block" style="padding-top: 30px;">
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                    ...
                                    <tbody>
                                      <?php
                                      $strSQL = "SELECT * FROM t5iw_submission a INNER JOIN t5iw_fileupload b on a.submission_id = b.submission_id WHERE a.username = ? ";
                                      $resultSubmission = $db->select($strSQL, array($_SESSION[$sprefix.'Username']));
                                        ...
                                        foreach ($resultSubmission as $value) {
                                          ...
                                          <tr>
                                              ...
                                              <td class="text-center" style="vertical-align: top;">
                                                  <div class="btn-group">
                                                      <a href="submission_info.php?sid=<?php echo $value['submission_id'];?>" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Client"><i class="fa fa-search"></i></a>
                                                  </div>
                                              </td>
                                          </tr>
                                          <?php
