    ...
    <body class="app-ui layout-has-drawer layout-has-fixed-header">
                          ...
                          <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1" style="padding-top: 80px;">
                            <div class="card">
                              <div class="card-header" style="padding-top: 30px; padding-bottom: 30px;">
                                  <h2 class="text-left" style="font-weight: 500; line-height: 0.8;">Update submission information
                                  </h2>
                              </div>
                              <div class="card-block" style="padding: 0px 24px ;">
                                <a href="./"><i class="fa fa-home"></i> Home</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="./">Submitted abstract</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="submission_info.php?sid=<?php echo $rowsubmission['submission_id'];?>"><?php echo $rowsubmission['id']; ?></a> &nbsp;&nbsp;/&nbsp;&nbsp;Update info.
                              </div>
                              <div class="card-block" style="padding-top: 30px;">
                                 <form class="js-validation-bootstrap form-horizontal" action="controller/insert-submission.php" method="post" >
                                   <div class="form-group">
                                     <label class="col-md-3 control-label" for="val-suggestions">Submission_id <span class="text-orange">*</span></label>
                                     <div class="col-md-8">
                                         <input type="text" name="txt-id" id="txt-id" readonly value="<?php echo $rowsubmission['submission_id'];?>" class="form-control">
                                     </div>
                                   </div>

                                   <div class="form-group">
                                     <label class="col-md-3 control-label" for="val-suggestions">Session_ID <span class="text-orange">*</span></label>
                                     <div class="col-md-8">
                                         <input type="text" name="txt-sid" id="txt-sid" readonly value="<?php echo $rowsubmission['sess_id'];?>" class="form-control">
                                     </div>
                                   </div>
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="col-md-8">
                                         <textarea class="form-control" id="txt-title" name="txt-title" rows="6" placeholder="Share your ideas with us.."><?php echo $rowsubmission['title'];?></textarea>
                                     </div>
                                   </div>
                            ...
                            <div class="col-md-8 col-md-offset-3" id="fileupload" style=" position: absolute; z-index: 999;">
                              <form class="dropzone" id="myFile" action="controller/upload_file_edit.php?id=<?php echo $rowsubmission['submission_id'];?>&sid=<?php echo $rowsubmission['sess_id'];?>"></form>
                            </div>
        ...
        <script type="text/javascript">
          $(document).ready(function(){
            var response = $.post('controller/check_upload_file_edit.php', { sid: $('#txt-sid').val() });
            response.always(function(res){
              $('#uploadResult').html(res);
            });

            var response2 = $.post('controller/check_upload_file2_edit.php', { sid: $('#txt-sid').val() });
